In this folder you'll find a project that can be imported into Android Studio.
This project contains several modules. The module called "bobEngine" is the BobEngine
library module that you will want to import to your own BobEngine projects. The
other modules included in this project are example applications that demonstrate how
to use BobEngine.

MODULES
bobEngine - Library module
